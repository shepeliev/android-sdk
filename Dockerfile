...
RUN /opt/android-accept-licenses.sh "/opt/android-sdk-linux/tools/android update sdk -a -u -t tools,platform-tools,build-tools-24.0.3,android-23,extra-android-m2repository,extra-google-m2repository" \
  && rm -rf /var/lib/apt/lists/*
